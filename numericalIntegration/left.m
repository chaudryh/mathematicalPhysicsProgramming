...
% integrates the given function using the Left Endpoint Rule. This function
...
function [area] = left(func, min, max, num)
...
%fprintf('Area by Left Endpoint Rule for numerical integration = %f', area);
